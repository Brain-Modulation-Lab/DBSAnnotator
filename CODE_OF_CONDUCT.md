...
* Focusing on what is best for the community and, in the case of this project,
  for the patients whose data it handles
...
* **Sharing identifiable patient data** in an issue, pull request, discussion or
  screenshot. This project handles clinical records; if you need to demonstrate a
  bug with real data, describe the shape of the data or use the synthetic example
...
**lucia.poma@wysscenter.ch**. All complaints will be reviewed and investigated
...
consequences of any action they deem in violation:
...
<https://www.contributor-covenant.org/version/2/1/code_of_conduct.html>, with an
added clause on patient data.
