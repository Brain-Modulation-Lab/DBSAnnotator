...
The repository includes a **synthetic** example session for exactly this purpose —
see ``test/fixtures/``, generated by ``tool/generate_fixtures.dart`` — and it
reproduces most format questions. This is also
