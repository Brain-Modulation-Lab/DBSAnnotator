...
def generate_iss(version: str) -> None:
    ...
    iss_content = """; Inno Setup installer script for ClinicalDBSAnnotator
...
#define AppExeName "ClinicalDBSAnnotator_Windows_{version_underscore}.exe"
...
Source: "dist\\ClinicalDBSAnnotator_Windows_{version_underscore}\\*"; DestDir: "{{{{app}}}}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
"""
    iss_content = iss_content.replace("{version}", version).replace(
